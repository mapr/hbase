...
import org.apache.hadoop.hbase.client.mapr.*;
...
public class HBaseAdmin implements Admin {
  ...
  private boolean isMapRDefault() {
    ...
    return tableMappingRule_.isMapRDefault();
  }
  ...
  public TableName[] listTableNamesInternal(final Pattern pattern, final boolean includeSysTables)
          throws IOException {
