...
public class ThriftHttpServlet extends TServlet {
  ...
  public ThriftHttpServlet(TProcessor processor, TProtocolFactory protocolFactory,
      UserGroupInformation serviceUGI, Configuration conf, ThriftServerRunner.HBaseHandler
      hbaseHandler, String authMethod, boolean doAsEnabled) throws IOException {
  ...
  private RemoteUserIdentity doKerberosAuth(HttpServletRequest request)
    ...
    try {
      ...
      LOG.error("Failed to authenticate with " + httpUGI.getUserName() + " kerberos principal");
