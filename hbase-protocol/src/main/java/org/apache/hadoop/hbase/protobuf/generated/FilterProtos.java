  ...
  private static final long serialVersionUID = 0L;
    ...
    private FirstKeyValueMatchingQualifiersFilter(
      ...
      try {
        ...
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          qualifiers_ = java.util.Collections.unmodifiableList(qualifiers_); // C
        }
        this.unknownFields = unknownFields.build();
        makeExtensionsImmutable();
      }
    ...
    public static final class Builder extends
      ...
      public java.util.List<com.google.protobuf.ByteString>
          getQualifiersList() {
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(qualifiers_) : qualifiers_;
      }
      /**
       * <code>repeated bytes qualifiers = 1;</code>
       * @return The count of qualifiers.
  ...
  private static final long serialVersionUID = 0L;
    ...
    private MultipleColumnPrefixFilter(
      ...
      try {
        ...
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          sortedPrefixes_ = java.util.Collections.unmodifiableList(sortedPrefixes_); // C
        }
        this.unknownFields = unknownFields.build();
        makeExtensionsImmutable();
      }
    ...
    public static final class Builder extends
      ...
      public java.util.List<com.google.protobuf.ByteString>
          getSortedPrefixesList() {
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(sortedPrefixes_) : sortedPrefixes_;
      }
      /**
       * <code>repeated bytes sorted_prefixes = 1;</code>
       * @return The count of sortedPrefixes.
